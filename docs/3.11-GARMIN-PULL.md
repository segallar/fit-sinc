...
В hub-модели GetSync ([ACTIVITY-HUB.md](ACTIVITY-HUB.md)) **Garmin Connect** — **source + sink**:

| Роль | Сейчас | **3.11** |
| ---- | ------ | -------- |
| **sink** | Bootstrap upload (HH→Garmin) | без изменений |
| **source** | Metadata в catalog (refresh) | **FIT pull** + wellness в hub |

1. **Скачивать `.fit`** активностей из Garmin в catalog/storage.
