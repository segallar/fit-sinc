...
| 301 `fit.romansegalla.online` → `app.getsync.me` | ops backlog |
| Редиректы `thefitsync.com`, `fitnesssync.io` | ops backlog |
...
- [ ] nginx: 301 с `fit.romansegalla.online` → `app.getsync.me` (отложено)
...
- [x] Этап 4: уровень C (инфра; legacy 301 → backlog)
