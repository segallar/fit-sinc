...
from getsync.garmin.session import garmin_login, garmin_status
from getsync.garmin.web_session import import_web_cookies, web_login as garmin_web_login
...
from getsync.sync.service import backfill_since, sync_activity
...
def user_create(
    ...
    from getsync.users.timezones import normalize_timezone
...
def hammerhead_auth(
    ...
    class CallbackHandler(BaseHTTPRequestHandler):
        def do_GET(self) -> None:  # noqa: N802
            ...
            self.end_headers()
            self.wfile.write(
                b"<html><body><h1>GetSync</h1><p>Hammerhead connected. You can close this tab.</p></body></html>"
            )
